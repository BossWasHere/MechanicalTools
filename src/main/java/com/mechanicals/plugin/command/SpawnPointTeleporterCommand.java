...
public class SpawnPointTeleporterCommand extends RegisteredCommand {

	public SpawnPointTeleporterCommand() {
		super();
	}
	...
	public void run(CommandSender sender, String[] args) {
		if (args.length < 1) {
			if (sender instanceof Player) {
				...
				if (player.hasPermission(plugin.bedTeleporter.commandPerm())) {
			...
			if (sender.hasPermission(plugin.bedTeleporter.commandOtherPerm())) {
