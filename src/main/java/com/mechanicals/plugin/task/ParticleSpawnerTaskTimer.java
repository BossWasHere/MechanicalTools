	...
	public void reload() {
		...
		for (String key : keys) {
			if (plugin.blockData.getBoolean("block.blockBreaker.showParticles") && MechanicalBlocks.BLOCK_BREAKER.getId().equals(plugin.placed.getString(key + ".id"))) {
				...
				mechBlocks.add(new Location(Bukkit.getWorld(plugin.placed.getString(key + ".world")), plugin.placed.getInt(key + ".x"), plugin.placed.getInt(key + ".y") + 1, plugin.placed.getInt(key + ".z")));
			} else if (plugin.blockData.getBoolean("block.miner.showParticles") && MechanicalBlocks.MINER.getId().equals(plugin.placed.getString(key + ".id"))) {
				mechBlocks.add(new Location(Bukkit.getWorld(plugin.placed.getString(key + ".world")), plugin.placed.getInt(key + ".x"), plugin.placed.getInt(key + ".y") + 1, plugin.placed.getInt(key + ".z")));
			} else if (plugin.blockData.getBoolean("block.autoCrafter.showParticles") && MechanicalBlocks.AUTO_CRAFTER.getId().equals(plugin.placed.getString(key + ".id"))) {
				mechBlocks.add(new Location(Bukkit.getWorld(plugin.placed.getString(key + ".world")), plugin.placed.getInt(key + ".x"), plugin.placed.getInt(key + ".y") + 1, plugin.placed.getInt(key + ".z")));
			}
		}
