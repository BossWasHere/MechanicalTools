...
public enum MechanicalBlocks {
	...
	AUTO_CRAFTER("autoCrafter", new ItemStack(Material.DROPPER));
	...
	public String getPlacePermission() { return MechMain.plugin.permissions.get(getId() + "_place"); }
	public String getBreakPermission() { return MechMain.plugin.permissions.get(getId() + "_break"); }
	public String getBreakOtherPermission() { return MechMain.plugin.permissions.get(getId() + "_breakOther"); }
