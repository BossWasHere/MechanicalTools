...
public class GeneratorCommand extends RegisteredCommand {
	...
	public void run(CommandSender sender, String[] args) {
		if (args.length < 1) {
			if (sender instanceof Player) {
				...
				if (player.hasPermission(plugin.generator.commandPerm())) {
					plugin.generator.giveBlockItem(player);
				} else {
